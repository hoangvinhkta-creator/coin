...
| 🟡 | WP-A2 — Bật các hạng mục đã viết nhưng pipeline chưa chạy | Báo cáo chính thức hiện thiếu nhiều mục mà đặc tả bắt buộc phải có, dù code đã đúng | C — Opus — high | Sau T-04, và cần **BLK-003** được gỡ. Song song với WP-A1, WP-A3 (đóng F-003, F-004, F-012, F-013, F-014). Tier ghi đè thủ công — router trả B, xem DEC-008/GOVDEF-001 |
