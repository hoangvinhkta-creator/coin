...
(`DEC-028`, 2026-09-03). Kế tiếp trên đường găng: `T-05` (Owner approval, PLANNED) và gỡ
`BLK-001` — cả hai ĐỘC LẬP với `GATE-A` và đều là điều kiện của `T-06`.
...
| PLANNED | T-06 | Chạy backtest chính thức trên dữ liệu thật | Mở cổng verdict — đây là đường găng tới mục tiêu cuối | C | xhigh | Hai nhóm điều kiện ĐỘC LẬP, phải thoả CẢ HAI: (A) nội tại — T-05 và **GATE-A** (WP-A1…**WP-A7** đều DONE — **GATE-A = CLOSED tại `DEC-028`, 2026-09-03**); (B) hạ tầng — BLK-001 (mạng Binance). Gỡ BLK-001 KHÔNG cho phép chạy T-06 nếu T-05 chưa duyệt. NOT READY: chờ (A) T-05 và (B) BLK-001 |
...
T-04 ✅
 └─> WP-A3 ✅
      ├─> WP-A4 ✅ ─┐   (DONE tại S009)
      └─> WP-A7 ✅ ─┤
                    └─> WP-A6 ✅ (S014) ──> GATE-A ✅ ──> T-06 ──> WP-B1 ──> T-07 ──> T-11
...
2026-09-03). T-06 vẫn cần ĐỘC LẬP: T-05 (Owner approval, PLANNED) và BLK-001 (hạ tầng) gỡ.
