...
WP-A5: sau WP-A2 ∧ WP-A3 ∧ WP-A7 — vẫn là prerequisite của GATE-A, còn READY (chưa chạy)
WP-A1, WP-A2: prerequisite của GATE-A. WP-A2 DONE; WP-A1 còn IN_PROGRESS (budget CAP-PROV hết,
chờ Owner) — KHÔNG nằm trên chuỗi dài nhất nhưng vẫn chặn GATE-A
GATE-A = WP-A1 ∧ WP-A2 ∧ WP-A3 ∧ WP-A4 ∧ WP-A5 ∧ WP-A6 ∧ WP-A7 đều DONE — CHƯA đóng (thiếu WP-A1, WP-A5)
