...
| `CAP-VERDICT` | Chính sách verdict, test đặc tả, audit trail | `WP-B1` | `WP-B1`, `WP-B2`, `WP-B3` | `WP-B1` DONE; `WP-B2` READY; `WP-B3` **IMPLEMENTED** (`S025`, 2026-09-04 — 8/8 REQUIRED PASS, đóng `F-024`/`F-033`; chưa `DONE`, chờ chủ dự án) | CÓ (lát cắt đã chạy — T-06 DONE) |
